...
<div class="easyui-layout" fit="true">
    ...
    <div region="center" style="padding:0px;border:0px" title="Customer Information Query from EBS (Account Opening)">
        ...
        <t:formvalid formid="ff" dialog="true" tiptype="null" layout="table" action="customerInfoController.do?savePayuCustomerInformation">
            <table cellpadding="0" cellspacing="1" class="formtable">
                ...
                <tr>
                    ...
                    <td class="value">
                            <%--获取客户端MAC地址--%>
                        <%--<input id="mac" name="mac" type="hidden" value="<%=macAddress%>">--%>
                        <input id="accNo" name="accNo" type="text" style="width: 150px;" class="accNo" value="" readonly="readonly"><span style="color: red">*</span>
                    </td>
                    <td align="right" style="width: 150px;">
                        <label class="Validform_label">
                            NRIC
                    ...
                    <td class="value">
                        <input id="nric" name="nric" type="text" style="width: 150px;" class="nric" value="" readonly="readonly"><span style="color: red">*</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="value">
                        <%--<select id="gstCode" name="gstCode" style="width: 150px"></select>--%>
...
<script type="text/javascript">
    ...
    function searchData(){
        ...
        $.ajax({
            type: "post",
            url: "customerInfoController.do?pauysearch",
