...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="customerInfoList" pageSize="10" checkbox="true" singleSelect="true" pagination="true" fitColumns="true"
                    title="Account Activation" actionUrl="customerInfoController.do?activationDatagrid" idField="accNo" fit="true" autoLoadData="false">
...
<script>
    ...
    function edit(accNo){
        ...
        var url = 'customerInfoController.do?goUpdate';
        url += '&accNo=' + accNo;
