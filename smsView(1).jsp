    ...
    <div region="center" style="padding:0px;border:0px">
        ...
        <div id="smsQuerytb" style="padding: 3px; height: 27px;border-bottom:1px solid #D7D7D7">
            <div style="float: left;" class="searchColums" >
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Send Time&nbsp;&nbsp;&nbsp;<input class="Wdate" type="text" id="firstSendTime" name="firstSendTime" onclick="WdatePicker({maxDate:'#F{$dp.$D(\'lastSendTime\')||\'%y-%M-%d\';}'})">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To&nbsp;&nbsp;&nbsp;<input class="Wdate" type="text" id="lastSendTime" name="lastSendTime" onclick="WdatePicker({minDate:'#F{$dp.$D(\'firstSendTime\');}',maxDate:'%y-%M-%d'})">
            </div>
            <div align="right">
